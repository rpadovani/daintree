<template>
  <div class="container mt-2">
    ...
    <gl-alert variant="tip" class="mb-2 mt-2" :dismissible="false">
      ...
      from which the public IP address is to be allocated. Elastic IP addresses
      incur charges if they are not associated with a running instance or a
      network interface that is attached to a running instance.
      <a
