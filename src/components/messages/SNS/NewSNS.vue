<template>
  <div class="container mt-2">
    ...
    <gl-alert variant="tip" class="mb-2 mt-2" :dismissible="false">
      ...
      It provides an access point for publishers and subscribers to communicate
      with each other.
    </gl-alert>
    <gl-form-group
      id="region-id"
...
import SNSClient, { CreateTopicInput } from "aws-sdk/clients/sns";
